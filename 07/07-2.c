...
int main()
{
  pthread_t thid_one, thid_two, mythid;
  int result;
  //
  ...
  //
  result = pthread_create(&thid_one, (pthread_attr_t *)NULL, mythread, NULL);
  ...
  //
  pthread_join(thid_one, (void **)NULL);

  result = pthread_create(&thid_two, (pthread_attr_t *)NULL, mythread, NULL);
  ...
  // distorting the results.
  //
  pthread_join(thid_two, (void **)NULL);
